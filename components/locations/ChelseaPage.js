	...
	const chelseaInsights = [
		{
			...
			content:
				"During the annual Chelsea Flower Show, we provide enhanced security services for local businesses and residences experiencing increased footfall. Our team understands the unique challenges this world-famous event brings to the area.",
		},
		{
			title: "River Thames Properties",
			content:
				"Properties along Chelsea Embankment face unique security challenges including flood risks and public access. We provide specialized solutions including water-resistant locks and enhanced ground-floor security.",
		},
		{
			title: "Artist Studios & Galleries",
			content:
				"Chelsea's thriving arts scene requires specialized security for valuable artworks. We offer discrete monitoring systems and access control suitable for galleries and private collections.",
		},
	];
					...
					<Grid
						...
						<Grid
							...
							<Typography
								...
								innovative security technology. Whether you&apos;re locked out
								of your Sloane Square townhouse, need high-security locks for
								your riverside apartment, or require a comprehensive security
								audit for your commercial premises, we deliver solutions that
								match Chelsea&apos;s exceptional standards.
							</Typography>
							<Typography
								paragraph
						...
						<Grid
							...
							<Grid
								...
								<Box sx={{ textAlign: "center" }}>
									<AccessTimeIcon
										sx={{ fontSize: 50, color: JW_CYAN, mb: 2 }}
									/>
									<Typography
										variant="h6"
