    ...
    <FooterContainer component="footer">
      <Container maxWidth="xl">
        ...
        <Box sx={{ display: 'flex', gap: 3, flexWrap: 'wrap', alignItems: 'center', mb: 4 }}>
          <Box component="img" src="/images/certifications/bafe.png" alt="BAFE Certified" sx={{ height: 34, opacity: 0.9 }} onError={(e) => (e.currentTarget.style.display = 'none')} />
          <Box component="img" src="/images/certifications/checkatrade.png" alt="Checkatrade" sx={{ height: 28, opacity: 0.9 }} onError={(e) => (e.currentTarget.style.display = 'none')} />
          <Box component="img" src="/images/certifications/insurance.png" alt="Fully Insured" sx={{ height: 28, opacity: 0.9 }} onError={(e) => (e.currentTarget.style.display = 'none')} />
        ...
        <Grid container spacing={{ xs: 4, md: 6 }}>
          {/* Column 1: Company info and socials */}
          <Grid item xs={12} md={4}>
            ...
            <Typography sx={{ 
              ...
              Providing premium security solutions for high-end residential and commercial properties in South London and Surrey since 1991.
            </Typography>
            
            <Box sx={{ display: 'flex', gap: 1.5, mb: 4 }}>
              <SocialIconButton size="small" component="a" href="https://www.facebook.com/jwsecurity" target="_blank" rel="noopener noreferrer">
                <FacebookIcon fontSize="small" />
              </SocialIconButton>
              <SocialIconButton size="small" component="a" href="https://www.twitter.com/jwsecurity" target="_blank" rel="noopener noreferrer">
                <TwitterIcon fontSize="small" />
              </SocialIconButton>
              <SocialIconButton size="small" component="a" href="https://www.linkedin.com/company/jwsecurity" target="_blank" rel="noopener noreferrer">
                <LinkedInIcon fontSize="small" />
              </SocialIconButton>
              <SocialIconButton size="small" component="a" href="https://www.instagram.com/jwsecurity" target="_blank" rel="noopener noreferrer">
          ...
          <Grid item xs={12} sm={6} md={2}>
            ...
            {quickLinks.map((link, index) => (
              <FooterLink 
                ...
                to={link.path}
              >
                <KeyboardArrowRightIcon sx={{ fontSize: 18, mr: 1, opacity: 0.7 }} />
                {link.label}
              </FooterLink>
            ))}
          </Grid>
          ...
          <Grid item xs={12} md={4}>
            ...
            <Box sx={{ mb: 3 }}>
              <ContactInfoItem>
                ...
                <Box>
                  <Typography sx={{ fontSize: '0.95rem', fontWeight: 500, mb: 0.3 }}>
              ...
              {newsletterStatus.message && (
                <Typography
                  sx={{
                    mt: 1,
                    fontSize: '0.85rem',
                    color: newsletterStatus.type === 'success' ? '#4caf50' : '#f44336'
                  }}
                >
                  {newsletterStatus.message}
                </Typography>
        ...
        <Box sx={{ 
          ...
          {isMobile && (
            <Typography variant="body2" sx={{ fontSize: '0.9rem', mb: { xs: 2, sm: 0 } }}>
              © {new Date().getFullYear()} JW Security. All Rights Reserved.
            </Typography>
          )}
          
          <Box sx={{ display: 'flex', gap: 3 }}>
            <Link to="/" style={{ color: alpha('#fff', 0.7), textDecoration: 'none', fontSize: '0.9rem' }}>
              Privacy Policy
            </Link>
            <Link to="/" style={{ color: alpha('#fff', 0.7), textDecoration: 'none', fontSize: '0.9rem' }}>
              Terms of Service
