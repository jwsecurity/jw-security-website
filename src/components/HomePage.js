...
// Simplified carousel animation keyframes
...
const HeroSectionStyled = styled(Box)(({ theme }) => ({
  ...
  textAlign: 'left',
  marginTop: 0,
  paddingTop: '5rem', // Base padding for all screens
  overflow: 'hidden', // Important to contain the absolute positioned collage grid
  // The HeroContent and other direct children will have zIndex to be on top
  [theme.breakpoints.down('md')]: {
    minHeight: 'unset',
    paddingTop: '6.5rem', // Increased padding for header on mobile
    paddingBottom: '5rem',
  },
...
// This component will sit inside HeroSectionStyled, behind HeroContent but above the collage
const HeroOverlay = styled(Box)({
  ...
  right: 0,
  bottom: 0,
  backgroundColor: 'rgba(28, 46, 74, 0.7)', // The gradient overlay
  zIndex: 2, // Ensures it's above the collage (zIndex 1) and below content (zIndex 3)
});
...
const HeroCollageGrid = styled(Box)(({ theme }) => ({
  ...
  gap: '0px',
  zIndex: 1, // Collage is at the very back
  [theme.breakpoints.down('md')]: {
...
const HeroContent = styled(Container)(({ theme }) => ({
  position: 'relative', // Ensure HeroContent can have a zIndex
  zIndex: 3, // HeroContent on top of everything
  ...
  height: '100%',
  [theme.breakpoints.down('md')]: {
    paddingLeft: theme.spacing(2.5), // Reduced from 3 to 2.5
  ...
  [theme.breakpoints.down('sm')]: {
    paddingLeft: theme.spacing(2), // Keep as 2 for small screens
    paddingRight: theme.spacing(2),
    paddingBottom: theme.spacing(3), // Reduced from previous
    width: '100%',
    maxWidth: '100%',
  },
}));
...
const HeroTitle = styled(Typography)(({ theme }) => ({
  ...
  fontWeight: 800,
  fontSize: '3rem', // Using rem for better scaling
  lineHeight: 1.2,
  marginBottom: '2.5rem',
  maxWidth: '600px',
...
const HeroSubtitle = styled(Typography)(({ theme }) => ({
  ...
  fontSize: '1.25rem', // Using rem for better scaling
  lineHeight: 1.5,
  fontWeight: 400,
  color: 'white',
  '& strong': {
  ...
  [theme.breakpoints.down('sm')]: {
    fontSize: '1.125rem', // 18px minimum for readability
  },
}));

const HeroPhoneNumber = styled(Typography)(({ theme }) => ({
  fontFamily: "'Poppins', Arial, sans-serif",
  fontSize: '1.5rem', // Using rem for better scaling
  fontWeight: 700,
  color: JW_CYAN,
  fontStyle: 'italic',
...
const HeroButton = styled(Button)(({ theme }) => ({
  ...
  [theme.breakpoints.down('md')]: {
    padding: '12px 30px', // Increased for better touch target
    fontSize: '16px', // Increased from 15px
    minHeight: '48px',
  },
  [theme.breakpoints.down('sm')]: {
    padding: '14px 25px', // Increased for mobile touch
    fontSize: '16px', // Increased from 14px to meet accessibility guidelines
    minHeight: '48px',
...
const Section = styled(Box)(({ theme, odd }) => ({
  ...
  [theme.breakpoints.down('sm')]: {
    padding: theme.spacing(4, 0), // Further reduced for small mobile
  },
}));
...
// Testimonial Carousel Component - Completely rewritten and memoized
const TestimonialCarousel = React.memo(({ testimonialsData }) => {
      ...
      <TestimonialCard sx={{ animation: `${animation} 0.5s ease forwards` }}>
        ...
        <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          <Box sx={{ display: 'flex', alignItems: 'center' }}>
            ...
            <Box>
              <Typography variant="subtitle1" sx={{ fontWeight: 600, color: JW_BLUE, mb: 0.3 }}>
                {testimonial.author}
              </Typography>
...
// Lazy load TestimonialCarousel for better performance
const LazyTestimonialCarousel = lazy(() => Promise.resolve({ default: TestimonialCarousel }));
  ...
  const faqData = [
    {
      ...
      answer: "You can get a free, no-obligation price quote by contacting us directly. We offer bespoke solutions, so every project begins with a free security check and insurance schedule review to understand your specific needs. This allows us to provide an accurate estimate. Call us or use the contact form on our website."
    },
    {
      question: "Can I become a regular customer or set up a maintenance contract?",
      answer: "Yes, we value long-term relationships with our clients. We work with many repeat customers, including residential properties, businesses, and managing agents. We can discuss regular maintenance schedules or ongoing security service agreements tailored to your requirements."
    },
    {
      question: "What areas do you cover?",
      answer: "JW Security is based in Wandsworth and our mobile service covers the whole of London as well as Surrey. If you're unsure whether we cover your specific area, please don't hesitate to contact us."
    },
    {
      question: "Do you offer emergency call-out services?",
      answer: "Yes, we provide a 24/7 emergency call-out service for urgent issues such as lockouts, burglary repairs, or critical security system failures. Our team aims to respond quickly to ensure your property is secured."
    },
    {
      question: "How long has JW Security been in business?",
      answer: "JW Security (previously known as 1st Call Security) was established in 1991. We have over 30 years of experience in providing locksmith and security related services to South London and Surrey."
    }
  ];
    ...
    <>
      ...
      <HeroSectionStyled>
        ...
        <HeroContent>
          ...
          >
            ...
            <motion.div variants={fadeInUpVariants}>
              <HeroButton variant="contained" disableElevation component={Link} to="/contact">
                Get a Free Quote
              </HeroButton>
            </motion.div>
          </motion.div>
      ...
      <Section>
        <Container sx={{ textAlign: 'center' }}>
          ...
          >
            <SectionTitle variant="h4" component="h2" sx={{ mb: 7, fontSize: '2.2rem' }}>
      ...
      {/* Meeting Your Security Needs Section */}
      <Section odd sx={{ py: { xs: 6, md: 8 } }}>
        <Container maxWidth="xl">
          <motion.div
            initial="hidden"
            whileInView="visible"
            ...
            {faqData.map((faq, index) => (
              ...
              >
                ...
                >
                  ...
                  <AccordionDetails>
                    <Typography sx={{ color: alpha('#000', 0.7), lineHeight: 1.7 }}>
                      {faq.answer}
                    </Typography>
                  </AccordionDetails>
                </Accordion>
              ...
              >
                ...
                >
                  ...
                  <Box sx={{ display: 'flex', alignItems: 'center', my: 3, justifyContent: 'center' }}>
                    ...
                    <Box>
                      <Typography sx={{ fontSize: '0.9rem', color: alpha('#fff', 0.85) }}>
                        Call our emergency hotline
                      </Typography>
                      <Typography sx={{ fontWeight: 700, fontSize: '1.8rem', color: JW_CYAN }}>
                        0208 646 7931
                      </Typography>
                    </Box>
                  </Box>
