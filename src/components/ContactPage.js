...
import { Box, Container, Typography, Grid, TextField, Button, Paper, Snackbar, Alert, Divider, CircularProgress } from '@mui/material';
        ...
        <Container maxWidth="xl">
          <Box sx={{ maxWidth: 700, position: 'relative', zIndex: 2 }}>
            ...
            <Typography variant="h6" sx={{ 
              ...
              We're here to help with all your security needs for luxury homes and businesses
            </Typography>
          </Box>
        </Container>
      </PageHero>
      ...
      <Box sx={{ py: { xs: 8, md: 10 } }}>
        <Container maxWidth="xl">
          <Box sx={{ maxWidth: 1100, mx: 'auto' }}>
            <Grid container spacing={5} justifyContent="center">
              <Grid item xs={12} md={4} sx={{ display: 'flex', justifyContent: 'center' }}>
                <Box sx={{ position: { md: 'sticky' }, top: { md: '100px' }, width: '100%', maxWidth: 420 }}>
                  <DecorativeLine />
                  ...
                  <Typography sx={{ 
                    ...
                    Whether you need emergency locksmith services, want to inquire about our premium security solutions, 
                    or have any questions, our team of experts is ready to assist you.
                  </Typography>
                  ...
                  <Grid item xs={12} sm={6}>
                    <ContactInfoCard sx={{ height: '100%' }}>
                      <Box sx={{ display: 'flex', alignItems: 'flex-start', height: '100%' }}>
                        ...
                        <Box>
                          <Typography variant="h6" sx={{ fontWeight: 700, mb: 0.5, color: JW_BLUE }}>
                            Phone
                          </Typography>
                          <Typography sx={{ mb: 0.5, fontWeight: 500 }}>0208 646 7931</Typography>
                    ...
                    <ContactInfoCard sx={{ height: '100%' }}>
                      <Box sx={{ display: 'flex', alignItems: 'flex-start', height: '100%' }}>
                        ...
                        <Box>
                          ...
                          <Typography sx={{ mb: 0.5, fontWeight: 500 }}>help@jwsecurity.co.uk</Typography>
                          <Typography variant="body2" sx={{ color: alpha('#000', 0.6) }}>
                    ...
                    <ContactInfoCard>
                      <Box sx={{ display: 'flex', alignItems: 'flex-start' }}>
                        <Box sx={{ 
                          ...
                          <LocationOnIcon sx={{ color: JW_CYAN, fontSize: 24 }} />
                        </Box>
                        <Box>
                          <Typography variant="h6" sx={{ fontWeight: 700, mb: 0.5, color: JW_BLUE }}>
                            Service Areas
          ...
          <Box sx={{ mt: 8, textAlign: 'center' }}>
            <Divider sx={{ mb: 5 }} />
            <Typography variant="h5" sx={{ fontWeight: 700, mb: 2, color: JW_BLUE }}>
              Opening Hours
            </Typography>
            <Grid container spacing={2} justifyContent="center">
              <Grid item xs={12} sm={4}>
                ...
                <Typography sx={{ color: alpha('#000', 0.6) }}>8:00 AM - 6:00 PM</Typography>
              </Grid>
              <Grid item xs={12} sm={4}>
                <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'center', mb: 1 }}>
                  <AccessTimeIcon sx={{ color: JW_CYAN, mr: 1 }} />
                ...
                <Typography sx={{ color: alpha('#000', 0.6) }}>9:00 AM - 4:00 PM</Typography>
              </Grid>
              <Grid item xs={12} sm={4}>
                <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'center', mb: 1 }}>
                  <AccessTimeIcon sx={{ color: JW_CYAN, mr: 1 }} />
                  <Typography sx={{ fontWeight: 500 }}>Emergency Service</Typography>
                </Box>
                <Typography sx={{ color: alpha('#000', 0.6) }}>24/7 Available</Typography>
              </Grid>
            </Grid>
          </Box>
          </Box>
