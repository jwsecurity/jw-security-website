...
// Styled components
const HeroWrapper = styled(Box)(({ theme, minHeight = '65vh', backgroundImage = '/images/jw/locksmith-maintenance.jpg' }) => ({
  position: 'relative',
  ...
  [theme.breakpoints.down('md')]: {
    minHeight: minHeight === '65vh' ? '50vh' : minHeight === '45vh' ? '40vh' : minHeight,
    padding: theme.spacing(8, 0, 6),
    paddingTop: `calc(${theme.spacing(8)} + 70px)`,
  },
  [theme.breakpoints.down('sm')]: {
    minHeight: minHeight === '65vh' ? '40vh' : minHeight === '45vh' ? '35vh' : minHeight,
...
const PageHero = ({ 
  ...
  return (
    <HeroWrapper minHeight={minHeight} backgroundImage={backgroundImage}>
      <Container>
        <Box sx={{ 
          maxWidth: 700, 
          position: 'relative', 
