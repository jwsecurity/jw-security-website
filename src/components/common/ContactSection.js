...
const ContactSectionWrapper = styled(Box)(({ theme }) => ({
  ...
  [theme.breakpoints.down('md')]: {
    padding: theme.spacing(5, 0), // Reduced padding for mobile
        ...
        <Grid container spacing={5} alignItems="center" justifyContent="center">
          <Grid item xs={12} md={7}>
            <Box sx={{
              ...
              <Typography 
                sx={{ 
                  fontSize: { xs: '1.125rem', md: '1.1rem' }, // Larger on mobile
                  mb: { xs: 3, md: 5 }, 
                  maxWidth: '600px',
                  lineHeight: 1.7,
                  color: alpha('#fff', 0.9)
            ...
            <Grid item xs={12} md={5}>
              ...
              >
                ...
                <Typography sx={{ mb: 1, fontSize: '1.1rem', lineHeight: 1.7 }}>
                  Need urgent assistance? Call our emergency hotline for immediate support.
                </Typography>
                ...
                <Button
                  component={Link}
                  to={`tel:${phoneNumber.replace(/\s+/g, '')}`}
                  fullWidth
                  variant="contained"
                  sx={{ 
                    bgcolor: JW_CYAN,
