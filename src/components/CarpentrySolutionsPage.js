...
const CarpentrySolutionsPage = () => {
  const jsonLd = {
    ...
    "description": "Professional carpentry services in London including door installation, window repairs, custom joinery, and emergency repairs. Expert craftsmen with 30+ years experience.",
    "offers": {
      "@type": "AggregateOffer",
      "priceCurrency": "GBP",
      "lowPrice": "150",
  ...
  const carpentryServices = [
    {
      ...
      description: 'Expert installation and repair of interior and exterior doors, including frames and hardware.',
      services: [
    ...
    },
    {
      ...
      description: 'Professional window repair, restoration, and replacement services for all property types.',
      services: [
    ...
    },
    {
      ...
      description: 'Complete kitchen installation services from cabinet fitting to worktop installation.',
      services: [
    ...
    },
    {
      ...
      description: 'Professional installation of various flooring types with precision and care.',
      services: [
    ...
    },
    {
      ...
      description: 'Construction, repair, and renovation of staircases and balustrade systems.',
      services: [
    ...
    },
    {
      ...
      description: 'Custom-made furniture and joinery solutions tailored to your specific requirements.',
      services: [
  ...
  return (
    <>
      <Helmet>
        <title>Carpentry Services London | Door Installation & Joinery | JW Security</title>
        <meta name="description" content="Expert carpentry services in London. Door installation, window repairs, custom joinery, kitchen fitting. Skilled craftsmen with 30+ years experience. Call 020 7946 0125." />
        <meta name="keywords" content="carpentry London, door installation, window repair, joinery services, custom carpentry, kitchen fitting, emergency carpenter London" />
        <link rel="canonical" href="https://jwsecurity.co.uk/services/carpentry" />
          ...
          <Grid container spacing={6}>
            <Grid item xs={12} md={6}>
              ...
              <Typography paragraph sx={{ mb: 3, fontSize: '1.05rem', lineHeight: 1.7 }}>
                Whether you need a door that won't close properly fixed today or are planning a complete home renovation, JW Security's carpentry division delivers craftsmanship you can trust. Our team of time-served carpenters brings decades of experience to every project, from emergency repairs to bespoke joinery installations.
              </Typography>
              <Typography paragraph sx={{ mb: 3, fontSize: '1.05rem', lineHeight: 1.7 }}>
                We understand that quality carpentry is about more than just wood and tools - it's about creating solutions that enhance your property while standing the test of time. Our carpenters are experts in both traditional techniques and modern methods, allowing us to work seamlessly with period properties in conservation areas as well as contemporary homes and offices.
              </Typography>
              <Typography paragraph sx={{ fontSize: '1.05rem', lineHeight: 1.7 }}>
                What truly sets us apart is our integrated approach. As part of JW Security, we ensure all carpentry work complements your property's security needs. Installing a new door? We'll make sure it's fitted with appropriate locks and meets insurance requirements. Need window repairs? We'll check the security hardware while we're there. This holistic approach saves you time and ensures nothing is overlooked.
              </Typography>
            </Grid>
            <Grid item xs={12} md={6}>
              <Box 
          ...
          <Grid container spacing={6} sx={{ my: 6 }}>
                ...
                {additionalServices.map((service, index) => (
                  <Grid item xs={12} sm={6} key={index}>
                    <Box sx={{ display: 'flex', alignItems: 'center', mb: 1 }}>
                      <HandymanIcon sx={{ fontSize: 20, color: JW_CYAN, mr: 1 }} />
            ...
            <Grid item xs={12} md={6}>
              ...
              <Typography sx={{ mt: 3, fontStyle: 'italic', color: alpha('#000', 0.6) }}>
                We can source and work with specific materials based on your project requirements.
              </Typography>
            </Grid>
          </Grid>
...
export default CarpentrySolutionsPage;