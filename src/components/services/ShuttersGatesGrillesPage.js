...
const ShuttersGatesGrillesPage = () => {
  const products = [
    {
      title: "Security Shutters",
      description: "Custom-designed security shutters providing robust protection for windows, doors, and other openings. Available in manual or electric operation.",
      features: [
    ...
    },
    {
      ...
      description: "Heavy-duty gates for entrances, driveways, and perimeter security. We offer retractable, sliding, and swinging gate options to suit various requirements.",
      features: [
    ...
    },
    {
      ...
      description: "Expandable or fixed grilles providing effective protection while maintaining visibility and ventilation. Ideal for commercial properties and ground-floor windows.",
      features: [
      ...
      <Box sx={{ py: { xs: 5, md: 8 }}}>
        <Container>
          <Grid container spacing={6}>
            <Grid item xs={12} md={6}>
              ...
              <Typography paragraph sx={{ mb: 3, fontSize: '1.05rem', lineHeight: 1.7 }}>
                JW Security provides high-quality security shutters, gates, and grilles to create robust physical barriers protecting your property from unauthorized access. Our solutions are custom-designed to meet your specific security requirements while complementing the aesthetics of your property.
              </Typography>
              <Typography paragraph sx={{ mb: 3, fontSize: '1.05rem', lineHeight: 1.7 }}>
                We offer a comprehensive service including consultation, design, manufacturing, and professional installation. Our experts will assess your property and recommend the most suitable security solutions based on your vulnerability assessment, usage patterns, and budget.
              </Typography>
              <Typography paragraph sx={{ fontSize: '1.05rem', lineHeight: 1.7 }}>
                All our products are constructed using durable materials and quality components to ensure reliable performance and long-term security. We work with both residential and commercial clients to enhance property protection through effective physical security barriers.
              </Typography>
            </Grid>
            <Grid item xs={12} md={6}>
              <Box 
            ...
            <Grid container spacing={4}>
              {products.map((product, index) => (
                <Grid item xs={12} md={4} key={index}>
                  <ProductCard>
                    <Typography variant="h5" component="h3" sx={{ fontWeight: 600, color: JW_BLUE, mb: 2 }}>
                      {product.title}
                    </Typography>
                    <Typography variant="body1" sx={{ color: alpha('#000', 0.7), mb: 3 }}>
                      {product.description}
                    </Typography>
                    <Divider sx={{ mb: 2 }} />
                    ...
                    <FeatureList>
                      {product.features.map((feature, idx) => (
                        <ListItem key={idx} disableGutters>
                          ...
                          <ListItemText primary={feature} primaryTypographyProps={{ fontSize: '0.95rem' }} />
                        </ListItem>
                      ))}
                    </FeatureList>
                  </ProductCard>
          ...
          <Box sx={{ my: 8 }}>
            ...
            <Typography paragraph sx={{ mb: 4, fontSize: '1.05rem', lineHeight: 1.7 }}>
              Our security shutters, gates, and grilles are suitable for a wide range of applications:
            </Typography>
            <Grid container spacing={4}>
            ...
            <Grid item xs={12} md={6}>
              ...
              <Box sx={{ mb: 3 }}>
                ...
                <Typography variant="body1" sx={{ mb: 3 }}>
                  We begin with a thorough assessment of your property to understand your security needs, usage patterns, and aesthetic preferences.
                </Typography>
                ...
                <Typography variant="body1" sx={{ mb: 3 }}>
                  Our team designs security solutions specifically for your property, ensuring proper fit and functionality.
                </Typography>
                ...
                <Typography variant="body1" sx={{ mb: 3 }}>
                  Experienced technicians install your security barriers with minimal disruption to your property or business.
                </Typography>
                ...
                <Typography variant="body1">
                  We perform thorough testing after installation to ensure all components work correctly and provide the intended security.
                </Typography>
              </Box>
            </Grid>
          </Grid>
...
export default ShuttersGatesGrillesPage;