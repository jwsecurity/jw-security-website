...
const BurglaryRepairsPage = () => {
  const services = [
    {
      title: "Door Repairs",
      description: "Complete repair or replacement of damaged doors, frames, and hardware to restore security."
    },
    {
      title: "Window Repairs",
      description: "Fixing or replacing broken windows, including emergency boarding up services."
    },
    {
      title: "Lock Replacement",
      description: "Installation of new high-security locks to replace compromised or damaged locking systems."
    },
    {
      title: "Security Upgrades",
      description: "Recommendations and implementation of enhanced security measures to prevent future break-ins."
    }
  ];
          ...
          <Grid container spacing={6}>
            <Grid item xs={12} md={6}>
              ...
              <Typography paragraph sx={{ mb: 3, fontSize: '1.05rem', lineHeight: 1.7 }}>
                After a break-in, securing your property quickly is essential for your safety and peace of mind. JW Security provides comprehensive burglary repair services to restore the security of your home or business with minimal delay.
              </Typography>
              <Typography paragraph sx={{ mb: 3, fontSize: '1.05rem', lineHeight: 1.7 }}>
                Our skilled technicians can repair or replace damaged doors, frames, windows, and locks, ensuring that your property is secure against further intrusion. We understand that burglaries can be distressing, so we work efficiently and professionally to help you regain your sense of security.
              </Typography>
              <Typography paragraph sx={{ fontSize: '1.05rem', lineHeight: 1.7 }}>
                In addition to repairs, we provide expert advice on security improvements to help prevent future incidents. Our services are available 24/7 for emergency situations, allowing us to secure your property quickly even after hours.
              </Typography>
            </Grid>
            <Grid item xs={12} md={6}>
              <Box 
          ...
          <Grid container spacing={6} sx={{ mt: 4 }}>
            ...
            <Grid item xs={12} md={6}>
              ...
              <List sx={{ pl: 2 }}>
                ...
                <ListItem sx={{ display: 'list-item', listStyleType: 'decimal' }}>
                  <Typography sx={{ fontSize: '1.05rem' }}>
                    Contact JW Security at <strong>0208 646 7931</strong> for emergency repairs
                  </Typography>
                </ListItem>
                <ListItem sx={{ display: 'list-item', listStyleType: 'decimal' }}>
                  <Typography sx={{ fontSize: '1.05rem' }}>
...
export default BurglaryRepairsPage;