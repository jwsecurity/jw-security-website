...
import { Box, Container, Typography, Grid, Card, CardContent, List, ListItem, ListItemIcon, ListItemText, Button, Paper, Chip } from '@mui/material';
...
const SecuritySystemsPage = () => {
  const securityServices = [
    {
      ...
      description: 'High-definition surveillance systems with remote viewing capabilities.',
      features: [
    ...
    },
    {
      ...
      description: 'Advanced alarm systems to detect and deter unauthorized access.',
      features: [
    ...
    },
    {
      ...
      description: 'Sophisticated entry management systems for enhanced security.',
      features: [
        'Card & fob systems',
        'Biometric readers',
        'Intercom systems',
    ...
    },
    {
      ...
      description: 'Control and monitor your security from anywhere in the world.',
      features: [
        'Real-time alerts',
  ...
  const systemBrands = [
    'Hikvision', 'Dahua', 'Axis', 'Bosch', 'Honeywell', 'Ajax',
    'Texecom', 'Pyronix', 'Videofied', 'Risco', 'Galaxy', 'HKC'
  ];

  const benefits = [
    {
      title: 'Crime Deterrent',
      description: 'Visible security systems significantly reduce the likelihood of break-ins'
    },
    {
    ...
    },
    {
      ...
      description: 'High-quality footage for police investigations and insurance claims'
    },
    {
      title: 'Peace of Mind',
    ...
    },
    {
      ...
      description: 'Many insurers offer discounts for professionally installed systems'
    },
    {
      ...
      <Box sx={{ py: { xs: 5, md: 8 } }}>
        <Container>
          <Grid container spacing={6}>
            <Grid item xs={12} md={6}>
              ...
              <Typography paragraph sx={{ mb: 3, fontSize: '1.05rem', lineHeight: 1.7 }}>
                JW Security specializes in designing and installing comprehensive security systems tailored to your specific needs. With over 30 years of experience, we provide cutting-edge solutions that offer maximum protection and peace of mind.
              </Typography>
              <Typography paragraph sx={{ mb: 3, fontSize: '1.05rem', lineHeight: 1.7 }}>
                Our systems combine the latest technology with professional installation to create robust security solutions. From simple CCTV setups to complex integrated systems, we ensure your property is protected 24/7.
              </Typography>
              <Typography paragraph sx={{ fontSize: '1.05rem', lineHeight: 1.7 }}>
                Every installation begins with a free security assessment where we identify vulnerabilities and recommend the most effective solutions within your budget. Our NSI Gold certified installers ensure compliance with all relevant standards.
              </Typography>
            </Grid>
            <Grid item xs={12} md={6}>
              <Box 
          ...
          <Box sx={{ my: 8 }}>
            ...
            <Typography paragraph sx={{ mb: 3, fontSize: '1.05rem', lineHeight: 1.7 }}>
              We work with industry-leading manufacturers to ensure reliable, high-quality security solutions:
            </Typography>
